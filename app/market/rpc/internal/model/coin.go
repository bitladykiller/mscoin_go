...
type Coin struct {
	ID                int     `db:"id"`
	Name              string  `db:"name"`
	CanAutoWithdraw   int     `db:"can_auto_withdraw"`
	CanRecharge       int     `db:"can_recharge"`
	CanTransfer       int     `db:"can_transfer"`
	CanWithdraw       int     `db:"can_withdraw"`
	CNYRate           float64 `db:"cny_rate"`
	EnableRPC         int     `db:"enable_rpc"`
	IsPlatformCoin    int     `db:"is_platform_coin"`
	MaxTxFee          float64 `db:"max_tx_fee"`
	MaxWithdrawAmount float64 `db:"max_withdraw_amount"`
	MinTxFee          float64 `db:"min_tx_fee"`
	MinWithdrawAmount float64 `db:"min_withdraw_amount"`
	NameCN            string  `db:"name_cn"`
	Sort              int     `db:"sort"`
	Status            int     `db:"status"`
	Unit              string  `db:"unit"`
	USDTRate          float64 `db:"usd_rate"`
	WithdrawThreshold float64 `db:"withdraw_threshold"`
	HasLegal          int     `db:"has_legal"`
	ColdWalletAddress string  `db:"cold_wallet_address"`
	MinerFee          float64 `db:"miner_fee"`
	WithdrawScale     int     `db:"withdraw_scale"`
	AccountType       int     `db:"account_type"`
	DepositAddress    string  `db:"deposit_address"`
	InfoLink          string  `db:"infolink"`
	Information       string  `db:"information"`
	MinRechargeAmount float64 `db:"min_recharge_amount"`
}
